...
public class Equipment implements org.apache.thrift.TBase<Equipment, Equipment._Fields>, java.io.Serializable, Cloneable, Comparable<Equipment> {
   ...
   * @see EquipmentType
   */
  public EquipmentType type; // required
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.ISO_ID};
  ...
  public Equipment setIsoId(String isoId) {
    this.isoId = isoId;
    return this;
  }
   ...
   * @see EquipmentType
   */
  public Equipment setType(EquipmentType type) {
    this.type = type;
    return this;
  }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Equipment struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.afarcloud.thrift.EquipmentType.findByValue(iprot.readI32());
