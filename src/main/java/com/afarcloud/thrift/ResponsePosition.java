...
public class ResponsePosition implements org.apache.thrift.TBase<ResponsePosition, ResponsePosition._Fields>, java.io.Serializable, Cloneable, Comparable<ResponsePosition> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ResponsePosition");
  ...
  static {
    schemes.put(StandardScheme.class, new ResponsePositionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ResponsePositionTupleSchemeFactory());
  }
  ...
  public com.afarcloud.thrift.Position Result; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ResponsePosition.class, metaDataMap);
  }
  ...
  public ResponsePosition(
    ...
    String Units,
    com.afarcloud.thrift.Position Result)
  {
    this();
   ...
   */
  public ResponsePosition(ResponsePosition other) {
    ...
    if (other.isSetResult()) {
      this.Result = new com.afarcloud.thrift.Position(other.Result);
    }
  }

  public ResponsePosition deepCopy() {
    return new ResponsePosition(this);
  }
  ...
  public ResponsePosition setTimestamp(long Timestamp) {
    this.Timestamp = Timestamp;
    setTimestampIsSet(true);
    return this;
  }
   ...
   * @see com.afarcloud.thrift.ObservationType
   */
  public ResponsePosition setObservation(com.afarcloud.thrift.ObservationType Observation) {
    this.Observation = Observation;
    return this;
  }
  ...
  public ResponsePosition setUnits(String Units) {
    this.Units = Units;
    return this;
  }
  ...
  public com.afarcloud.thrift.Position getResult() {
    return this.Result;
  }

  public ResponsePosition setResult(com.afarcloud.thrift.Position Result) {
    this.Result = Result;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT:
      if (value == null) {
        ...
        setResult((com.afarcloud.thrift.Position)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ResponsePosition)
      return this.equals((ResponsePosition)that);
    return false;
  }

  public boolean equals(ResponsePosition that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ResponsePosition other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ResponsePosition(");
    boolean first = true;
  ...
  private static class ResponsePositionStandardSchemeFactory implements SchemeFactory {
    public ResponsePositionStandardScheme getScheme() {
      return new ResponsePositionStandardScheme();
    }
  }

  private static class ResponsePositionStandardScheme extends StandardScheme<ResponsePosition> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ResponsePosition struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // RESULT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Result = new com.afarcloud.thrift.Position();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResponsePosition struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ResponsePositionTupleSchemeFactory implements SchemeFactory {
    public ResponsePositionTupleScheme getScheme() {
      return new ResponsePositionTupleScheme();
    }
  }

  private static class ResponsePositionTupleScheme extends TupleScheme<ResponsePosition> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ResponsePosition struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ResponsePosition struct) throws org.apache.thrift.TException {
